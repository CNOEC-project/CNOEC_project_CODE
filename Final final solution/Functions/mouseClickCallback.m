...
% MOUSECLICKCALLBACL: Display Optimal Racing Line Parameters at Mouse Click
%
% Output:
%   A text box is displayed on the plot showing the selected parameters
%   corresponding to the point on the racing line closest to the mouse click.
