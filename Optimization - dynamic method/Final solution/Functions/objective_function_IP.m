function J = objective_function_IP(z_full,u_vec,N,chassis,tyre,s_col,z_norm_factor,u_norm_factor,k_col,B_col,nz_grid_points,OPT_d)
    ...
    J = 0;                      % Initialize the objective function 
