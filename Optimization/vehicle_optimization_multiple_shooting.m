...
[x_opt, fval] = fmincon(@(z,u) vehicle_cost_function_optimal_control(z,u,th,circuit), u0, [], [], [], [], lb, ub, @(u) vehicle_nonlinear_constraints(z0,u,th,circuit,min_values,max_values), options);