...
[F_drag,F_lift,Fz_f,Fz_r,Fx_f,Fx_r,Fy_f,Fy_r] = forces_computation(z,u,chassis,tyre);

F = [F_drag,F_lift,Fz_f,Fz_r,Fx_f,Fx_r,Fy_f,Fy_r]';
...
z_prime(5,1)  =   (omega_z*t_prime-rho);                                                          % epsilon_prime
